...
const checkAns = (correct, mainContent, input) => {
    if(md5(input) == "f3f58ee455ae41da2ad5de06bf55e8de" || md5(input) == "234782fd089cf4486e960fa0c570f590" || md5(input) == "5b11962dcbe85de55770d22d3e5fb85a" || md5(input) == "817857b0693710898411438234078b55" || md5(input) == "2d351990d450cc028c016c2943b07013" || md5(input) == "b631d0cfde68df7d5a68d8a4b60f45e2"){
